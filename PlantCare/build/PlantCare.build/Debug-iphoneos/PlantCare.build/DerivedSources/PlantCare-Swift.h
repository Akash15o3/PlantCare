...
SWIFT_CLASS("_TtC9PlantCare11AppDelegate")
...
SWIFT_CLASS("_TtC9PlantCare21LandingViewController")
@interface LandingViewController : UIViewController
- (void)viewDidLoad;
- (IBAction)onSignup:(id _Nonnull)sender;
- (IBAction)onLoginButton:(id _Nonnull)sender;
...
SWIFT_CLASS("_TtC9PlantCare19LoginViewController")
...
SWIFT_CLASS("_TtC9PlantCare13SceneDelegate")
...
SWIFT_CLASS("_TtC9PlantCare20SignupViewController")
...
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified rePassField;
- (void)viewDidLoad;
